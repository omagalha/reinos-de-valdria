...
### Recomendado para a v4.16 completa
...
2. Dê dois cliques em \`INICIAR_JOGO.bat\` para a aventura atual ou em \`INICIAR_LAB_V416.bat\` para abrir a exploração Phaser.

...
### Recomendado para a v4.17 completa
...
2. Dê dois cliques em \`INICIAR_JOGO.bat\` para a aventura atual ou em \`INICIAR_LAB_V417.bat\` para abrir a exploração Phaser.
